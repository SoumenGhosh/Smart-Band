...
SoftwareSerial serial_connection(D1, D2); // rx 10, tx 11
TinyGPSPlus gps;
...
//  Serial.println("Satelite count:");
//  int data8 = root["data8"];
//  Serial.println(data8);

//  Serial.println("Latitude:");
//  double data9 = root["data9"];
//  Serial.println(data9);
//  
//  Serial.println("Longitude:");
//  double data10 = root["data10"];
//  Serial.println(data10);
//
//  Serial.println("Altitude feet:");
//  double data11 = root["data11"];
//  Serial.println(data11);
//  
//  Serial.println("Speed MPH:");
//  double data12 = root["data12"];
...
//  Firebase.pushString("Gas", firebaseH2, firebaseLPG, firebaseCO);
